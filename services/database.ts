...
const SUPABASE_URL = getSafeEnv('SUPABASE_URL', 'https://zjounhlaffzxxrgjylsb.supabase.co');
const SUPABASE_KEY = getSafeEnv('SUPABASE_ANON_KEY', 'sb_publishable_kKc46uzgd05dFhYHyJVGwQ_0MQ36oCj');
